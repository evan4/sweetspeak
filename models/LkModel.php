...
class LkModel
{
    ...
    public function GenerateLk() // Индексная страница личного кабинета
    {
        ...
        $this->navbar=Navbar::TestNav('Главная',require 'config/nav_pages.php',true);
        $this->content='';
    }
